...
import { updatePathWithQueryParams, windowScrollTo, getAllPossibleQueryParams } from '../data/utils';
...
const ResetPasswordPage = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isPasswordValid && isPasswordConfirmed) {
      ...
      const params = getAllPossibleQueryParams(window.location.search);
